...
String[] fields;
String patternStr = ",";
FileReader fin = new FileReader("customers.txt");
BufferedReader bin = new BufferedReader (fin);
FileOutputStream fout = new FileOutputStream("customers.htm");
BufferedOutputStream bout = new BufferedOutputStream(fout);
PrintStream pout = new PrintStream(bout);
pout.println("<body bgcolor=white><table border=1 width=1080 align=center>");
pout.println("<tr bgcolor=gray align=center><td>NO</td><td>customerid</td><td>companyname</td><td>contactname</td><td>contacttitle</td><td>address</td></tr>");
while ((b =  bin.readLine()) != null) {
fields = b.split(patternStr);
if(i%2 == 0)
pout.println("<tr bgcolor=Cyan>");
else
pout.println("<tr bgcolor=SandyBrown>");
