...
String[] fields;
String patternStr = ",";
FileReader fin = new FileReader("suppliers.txt");
BufferedReader bin = new BufferedReader (fin);
FileOutputStream fout = new FileOutputStream("suppliers.htm");
BufferedOutputStream bout = new BufferedOutputStream(fout);
PrintStream pout = new PrintStream(bout);
pout.println("<body bgcolor=white><table border=1 width=1080 align=center>");
pout.println("<tr bgcolor=gray align=center><td>NO</td><td>supplierid</td><td>companyname</td><td>contactname</td><td>contacttitle</td><td>address</td></tr>");
